  ...
  return (
    <>
      ...
      >
        ...
        >
          <h1 className="text-black font-title">Intro</h1>
        </div>
        <div
          id="Portfolio"
          ref={portfolioRef}
        ...
        >
          <h1 className="text-black font-title">Portfolio</h1>
        </div>
        <div
          id="About Me"
          ref={aboutRef}
          className="flex items-center justify-center h-[1000px] flex-shrink-0 w-full bg-emerald-200"
        >
          <h1 className="text-black font-title">About Me</h1>
        </div>
        <div
          id="Contact"
          ref={contactRef}
          className="flex items-center justify-center h-[1000px] flex-shrink-0 w-full bg-emerald-100"
        >
          <h1 className="text-black font-title">Contact</h1>
        </div>
      </Sidebar>
    </>
  );
